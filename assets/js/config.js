...
const CERT_CATALOG = {
  ...
  cism: {
    ...
    estimateWeeks: 8,
    dailyHours: 2,
    indexPath: 'cism/index.html',
    domains: [
      {
        id: 'cism_d1',
        name: 'Information Security Governance',
        shortName: 'Governance',
        path: 'cism/domain1/index.html',
        quizId: 'cism_d1_quiz',
        flashcardsPath: 'cism/domain1/flashcards.html',
        quizPath: 'cism/domain1/quiz.html',
        estimateMins: 360,
        weight: '17%',
      },
      {
        ...
        path: 'cism/domain2/index.html',
        quizId: 'cism_d2_quiz',
        flashcardsPath: 'cism/domain2/flashcards.html',
        quizPath: 'cism/domain2/quiz.html',
        estimateMins: 420,
        weight: '20%',
      },
      {
        ...
        path: 'cism/domain3/index.html',
        quizId: 'cism_d3_quiz',
        flashcardsPath: 'cism/domain3/flashcards.html',
        quizPath: 'cism/domain3/quiz.html',
        estimateMins: 480,
        weight: '33%',
      },
      {
        ...
        path: 'cism/domain4/index.html',
        quizId: 'cism_d4_quiz',
        flashcardsPath: 'cism/domain4/flashcards.html',
        quizPath: 'cism/domain4/quiz.html',
        estimateMins: 420,
        weight: '30%',
      },
    ],
  ...
  ccsk: {
    ...
    domains: [
      ...
      },
      {
        ...
        path: 'ccsk/09-data-security.html',
        quizId: 'ccsk_d9_quiz',
        estimateMins: 150,
      },
      {
  ...
  cobit: {
    ...
    estimateWeeks: 3,
    dailyHours: 2,
    indexPath: 'cobit/index.html',
    domains: [
      {
        id: 'cobit_d1',
        name: 'Framework Introduction',
        shortName: 'Introduction',
        path: 'cobit/01-framework-intro.html',
  ...
  cissp: {
    ...
    estimateWeeks: 10,
    dailyHours: 2,
    indexPath: 'cissp/index.html',
    domains: [
      {
        id: 'cissp_d1',
        name: 'Security and Risk Management',
        shortName: 'Risk Management',
        path: 'cissp/index.html#d1',
  ...
  aws: {
    ...
    domains: [
      ...
      },
      {
        ...
        shortName: 'Logging',
        path: 'aws-security/index.html#d2',
        quizId: 'aws_d2_quiz',
        estimateMins: 180,
        weight: '18%',
      },
      {
        ...
        path: 'aws-security/index.html#d3',
        quizId: 'aws_d3_quiz',
        estimateMins: 240,
        weight: '20%',
      },
      {
        ...
        name: 'Identity and Access Management',
        shortName: 'IAM',
        path: 'aws-security/index.html#d4',
        quizId: 'aws_d4_quiz',
        estimateMins: 240,
        weight: '16%',
      },
      {
        ...
        path: 'aws-security/index.html#d5',
        quizId: 'aws_d5_quiz',
        estimateMins: 240,
        weight: '18%',
      },
      {
        ...
        shortName: 'Governance',
        path: 'aws-security/index.html#d6',
        quizId: 'aws_d6_quiz',
        estimateMins: 180,
        weight: '14%',
      },
  ...
  azure: {
    ...
    estimateWeeks: 4,
    dailyHours: 2,
    indexPath: 'azure-security/index.html',
    domains: [
      {
        id: 'azure_d1',
        name: 'Manage Identity and Access',
        shortName: 'Identity and Access',
        path: 'azure-security/index.html#d1',
      ...
      },
      {
        ...
        path: 'azure-security/index.html#d2',
      ...
      },
      {
        ...
        path: 'azure-security/index.html#d3',
      ...
      },
      {
        ...
        path: 'azure-security/index.html#d4',
  ...
  gcp: {
    ...
    estimateWeeks: 4,
    dailyHours: 2,
    indexPath: 'gcp-security/index.html',
    domains: [
      {
        id: 'gcp_d1',
        name: 'Configuring Access',
        shortName: 'Access Config',
        path: 'gcp-security/index.html#d1',
        quizId: 'gcp_d1_quiz',
        estimateMins: 240,
        weight: '27%',
      },
      {
        ...
        shortName: 'Network Security',
        path: 'gcp-security/index.html#d2',
        quizId: 'gcp_d2_quiz',
        estimateMins: 240,
        weight: '23%',
      },
      {
        ...
        shortName: 'Data Protection',
        path: 'gcp-security/index.html#d3',
        quizId: 'gcp_d3_quiz',
        estimateMins: 180,
        weight: '20%',
      },
      {
        ...
        path: 'gcp-security/index.html#d4',
        quizId: 'gcp_d4_quiz',
        estimateMins: 180,
        weight: '17%',
      },
      {
        ...
        path: 'gcp-security/index.html#d5',
        quizId: 'gcp_d5_quiz',
        estimateMins: 120,
        weight: '13%',
      },
